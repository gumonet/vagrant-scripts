...
mysql --user="root" --password="secret" -e "CREATE USER 'wordpress'@'0.0.0.0' IDENTIFIED BY 'secret';"
mysql --user="root" --password="secret" -e "GRANT ALL ON *.* TO 'wordpress'@'0.0.0.0' IDENTIFIED BY 'secret' WITH GRANT OPTION;"
mysql --user="root" --password="secret" -e "GRANT ALL ON *.* TO 'wordpress'@'%' IDENTIFIED BY 'secret' WITH GRANT OPTION;"
